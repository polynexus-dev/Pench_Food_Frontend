  ...
  return (
    <div className="space-y-2 w-full">
      ...
      <div className="relative group">
        ...
        <input 
          {...props}
          className={`w-full pl-11 pr-4 py-2.5 bg-silver/10 border border-silver/50 rounded-2xl focus:ring-4 focus:ring-primary/5 focus:border-primary/20 transition-all outline-none font-semibold text-sm ${inputClassName}`}
        />
      </div>
    </div>
  );
